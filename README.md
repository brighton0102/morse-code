...
```sh
  cd my-folder
  git clone https://github.com/brighton0102/morse-code
```
...
Feel free to check the [issues page](https://github.com/brighton0102/morse-code/issues).
...
This project is [MIT](https://github.com/brighton0102/morse-code/blob/dev/LICENSE) licensed.
